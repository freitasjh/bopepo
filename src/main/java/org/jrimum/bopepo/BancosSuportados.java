...
public enum BancosSuportados {
	...
	/*
	 * <=====================================================================>
	 * Observe que toda a enumeração segue a ORDEM dos códigos de compensação. Caso
	 * queira modificar alguma coisa, leve sempre em consideração essa ORDEM.
	 * <=====================================================================>
	 */

	/**
	 * Tipo enumerado que representa o <strong>Banco do Brasil</strong>, código de
	 * compensação <strong><tt>001</tt></strong>
	...
	/**
	 * Tipo enumerado que representa o <strong>Banco do Nordeste do Brasil</strong>,
	 * código de compensação <strong><tt>004</tt></strong>
	...
	/**
	 * Tipo enumerado que representa o Banestes, <strong>Banco do Estado do Espírito
	 * Santo</strong>, código de compensação <strong><tt>021</tt></strong>
	 * <a href="http://www.banestes.com.br"> site</a>.
	 * 
	 * @since 0.2
	 */
	BANCO_DO_ESTADO_DO_ESPIRITO_SANTO("021", "28127603000178", "BANCO DO ESTADO DO ESPIRITO SANTO S.A.",
			"Banco Múltiplo"),

	/**
	 * Tipo enumerado que representa o Santander <strong>Banco Santander (Brasil) S.
	 * A.</strong>, código de compensação <strong><tt>033</tt> </strong>
	 * <a href="http://www.santander.com.br"> site</a>.
	 * 
	 * @since 0.2
	 */
	 ...
	 * Grande do Sul</strong>, código de compensação <strong><tt>041</tt></strong>
	 * <a href="http://www.banrisul.com.br/"> site</a>.
	 * 
	 * @since 0.2
	 */
	BANCO_DO_ESTADO_DO_RIO_GRANDE_DO_SUL("041", "92702067000196", "BANCO DO ESTADO DO RIO GRANDE DO SUL S.A.",
			"Banco Múltiplo"),
	 ...
	 * código de compensação <strong><tt>077</tt></strong>
	 ...
	 * Crédito Urbano</strong>, código de compensação <strong><tt>085</tt></strong>
	 * <a href="http://www.cecred.coop.br/"> site</a>.
	 * 
	 * @since 0.2
	 */
	...
	/**
	 * Tipo enumerado que representa o Banco <strong>Bradesco</strong>, código de
	 * compensação <strong><tt>237</tt></strong>
	 ...
	 * <p>
	 * Obs: Os bancos <strong>Sudameris</strong> e <strong>Bandepe</strong> foram
	 * incorporados ao Banco Real, portanto para gerar boletos bancários dos bancos
	 * citados utilize este tipo enumerado.
	 * </p>
	 * 
	 * @since 0.2
	 */
	...
	/**
	 * Tipo enumerado que representa o <strong>HSBC</strong>, código de compensação
	 * <strong><tt>399</tt></strong> <a href="http://www.hsbc.com.br">site</a>.
	 * 
	 * @since 0.2
	 */
	 ...
	 * 
	 */
	UNICRED("136", "00315557000111", "UNICRED S.A", "Banco Comercial Cooperativo");
	...
	static {
		...
		suportados.put(BANCO_DO_ESTADO_DO_RIO_GRANDE_DO_SUL.codigoDeCompensacaoBACEN,
	...
	/**
	 * Códigos de instituições bancárias na compensação - COMPE
	 * <a href="http://www.bcb.gov.br/?CHEQUESCOMPE">BACEN</a>.
	 * 
	 * @since 0.2
	 */
	...
	/**
	 * Nome da instituição registrado na
	 * <a href="http://www.bcb.gov.br/?CHEQUESCOMPE">BACEN</a>.
	 * 
	 * @since 0.2
	 */
	...
	/**
	 * Segmento bancário da instituição registrado na
	 * <a href="http://www.bcb.gov.br/?CHEQUESCOMPE">BACEN</a>.
	 * 
	 * @since 0.2
	 */
	...
	/**
	 * <p>
	 * Construtor naturalmente <code>private</code> responsável por criar uma única
	 * instância para cada banco.
	 * </p>
	 * 
	 ...
	 */
	public Banco create() {
		return new Banco(new CodigoDeCompensacaoBACEN(this.codigoDeCompensacaoBACEN), this.instituicao,
				new CNPJ(this.cNPJ), this.segmento);
	}
